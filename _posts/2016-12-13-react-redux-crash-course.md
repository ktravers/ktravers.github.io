...
2. `mix phoenix.new redux_chat_hedgehog`
  - using phoenix bc it has nice tools for modern web workflow
3. comment out db username and password in `config/dev.exs`
4. `mix deps.get`
5. `mix ecto.create`
6. cleanup boilerplate in `web/templates/page/index.html`
  - add something actually interesting
